...
//			AddTaskFunc: func(ctx context.Context, db store.Queryer, t *entity.Task) error {
...
func (mock *TaskAdderMock) AddTask(ctx context.Context, db store.Queryer, t *entity.Task) error {
